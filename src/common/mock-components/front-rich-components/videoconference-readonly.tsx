...
const VideoConferenceSizeRestrictions: ShapeSizeRestrictions = {
  minWidth: 200,
  minHeight: 200,
  maxWidth: -1,
  maxHeight: -1,
...
export const getVideoConferenceSizeRestrictions = (): ShapeSizeRestrictions =>
  VideoConferenceSizeRestrictions;
